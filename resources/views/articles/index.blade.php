    ...
    <form class="flex min-w-36 w-full align-content-end items-center justify-end gap-2">
        <div class="relative w-full max-w-xs">
            <button type="submit" id="search_button"
                class="absolute inset-y-0 w-9 h-9 left-0 flex items-center justify-center pointer-events-none text-gray-400 ">
                <svg xmlns="http://www.w3.org/2000/svg" class=" fill-white flex items-center p-1" x="0px" y="0px"
